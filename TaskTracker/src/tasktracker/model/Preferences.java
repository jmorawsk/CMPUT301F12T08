...
public class Preferences {
	 ...
	 */
	public static void setUsername(Context context, String value, Boolean changePreferences){
	...
	/**
	 * Changes the user password setting in the preferences file and the cached variable
	 * @param context 	the Activity context (use getBaseContext())
	 * @param value 	the new user password string
	 */
	public static void setPassword(Context context, String value, Boolean changePreferences){
		if (changePreferences){
			SharedPreferences settings = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
			SharedPreferences.Editor editor = settings.edit();
	...
	/**
	 * Changes the user email setting in the preferences file and the cached variable
	 * @param context 	the Activity context (use getBaseContext())
