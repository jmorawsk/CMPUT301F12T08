...
//		_solo.clickOnButton("Clear SQL Database");
	...
	public void void_testTaskNameInputs() {
		...
		// Can only find the first 60 chars typed in, since edit text only allows max 60 chars
		Assert.assertFalse(_solo.searchText(moreThan60Chars));
		Assert.assertTrue(_solo.searchText("abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefgh"));
